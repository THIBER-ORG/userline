...
re_srcsid = re.compile(r'<Data +Name="SubjectUserSid">(.+)</Data>')
re_dstsid = re.compile(r'<Data +Name="TargetUserSid">(.+)</Data>')
re_srcuser = re.compile(r'<Data +Name="SubjectUserName">(.+)</Data>')
re_srcdomain = re.compile(r'<Data +Name="SubjectDomainName">(.+)</Data>')
